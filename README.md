...
Panel template `example/panel.svg` — three rect placeholders for two figures and a formula:

![panel template](example/panel.svg)

Input figures generated by `example/subfigures.py`:

| `logistic_log.svg` | `logistic.svg` |
|:------------------:|:--------------:|
| ![logistic_log](example/logistic_log.svg) | ![logistic](example/logistic.svg) |
